...
program
    ...
    .option('--client-id <id>', 'Azure AD application (client) ID (saved to tenant.json)', DEFAULT_CLIENT_ID)
    .option('--tenant-id <id>', 'Azure AD tenant ID (saved to tenant.json)', DEFAULT_TENANT_ID)
